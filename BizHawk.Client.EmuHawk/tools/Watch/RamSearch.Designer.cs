namespace BizHawk.Client.EmuHawk
{
	partial class RamSearch
	{
		...
		private void InitializeComponent()
		{
			...
			this.AddressRangeBox = new System.Windows.Forms.GroupBox();
			this.AddressEndFilterBox = new BizHawk.Client.EmuHawk.HexTextBox();
			this.AddressStartFilterBox = new BizHawk.Client.EmuHawk.HexTextBox();
			this.IncludeEndAddressFilterCheck = new System.Windows.Forms.CheckBox();
			this.EndAddressFilterCheck = new System.Windows.Forms.CheckBox();
			this.IncludeStartAddressFilterCheck = new System.Windows.Forms.CheckBox();
			this.StartAddressFilterCheck = new System.Windows.Forms.CheckBox();
			...
			this.AddressRangeBox.SuspendLayout();
			this.SuspendLayout();
			// 
			// SearchMenuItem
			// 
			...
			this.WatchListView.Size = new System.Drawing.Size(230, 494);
			...
			this.MessageLabel.Location = new System.Drawing.Point(9, 562);
			...
			this.AutoSearchCheckBox.Location = new System.Drawing.Point(316, 521);
			...
			this.SearchButton.Location = new System.Drawing.Point(244, 520);
			...
			this.label2.Location = new System.Drawing.Point(327, 469);
			...
			// AddressRangeBox
			// 
			this.AddressRangeBox.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.AddressRangeBox.Controls.Add(this.AddressEndFilterBox);
			this.AddressRangeBox.Controls.Add(this.AddressStartFilterBox);
			this.AddressRangeBox.Controls.Add(this.IncludeEndAddressFilterCheck);
			this.AddressRangeBox.Controls.Add(this.EndAddressFilterCheck);
			this.AddressRangeBox.Controls.Add(this.IncludeStartAddressFilterCheck);
			this.AddressRangeBox.Controls.Add(this.StartAddressFilterCheck);
			this.AddressRangeBox.Location = new System.Drawing.Point(244, 362);
			this.AddressRangeBox.Name = "AddressRangeBox";
			this.AddressRangeBox.Size = new System.Drawing.Size(190, 100);
			this.AddressRangeBox.TabIndex = 106;
			this.AddressRangeBox.TabStop = false;
			this.AddressRangeBox.Text = "Address Range";
			// 
			// AddressEndFilterBox
			// 
			this.AddressEndFilterBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
			| System.Windows.Forms.AnchorStyles.Right)));
			this.AddressEndFilterBox.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
			this.AddressEndFilterBox.Enabled = false;
			this.AddressEndFilterBox.Location = new System.Drawing.Point(114, 54);
			this.AddressEndFilterBox.MaxLength = 8;
			this.AddressEndFilterBox.Name = "AddressEndFilterBox";
			this.AddressEndFilterBox.Nullable = false;
			this.AddressEndFilterBox.Size = new System.Drawing.Size(72, 20);
			this.AddressEndFilterBox.TabIndex = 27;
			this.AddressEndFilterBox.TextChanged += new System.EventHandler(this.RefreshEndFilter);
			// 
			// AddressStartFilterBox
			// 
			this.AddressStartFilterBox.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
			| System.Windows.Forms.AnchorStyles.Right)));
			this.AddressStartFilterBox.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
			this.AddressStartFilterBox.Enabled = false;
			this.AddressStartFilterBox.Location = new System.Drawing.Point(114, 17);
			this.AddressStartFilterBox.MaxLength = 8;
			this.AddressStartFilterBox.Name = "AddressStartFilterBox";
			this.AddressStartFilterBox.Nullable = false;
			this.AddressStartFilterBox.Size = new System.Drawing.Size(72, 20);
			this.AddressStartFilterBox.TabIndex = 26;
			this.AddressStartFilterBox.TextChanged += new System.EventHandler(this.RefreshStartFilter);
			// 
			// IncludeEndAddressFilterCheck
			// 
			this.IncludeEndAddressFilterCheck.AutoSize = true;
			this.IncludeEndAddressFilterCheck.Enabled = false;
			this.IncludeEndAddressFilterCheck.Location = new System.Drawing.Point(7, 71);
			this.IncludeEndAddressFilterCheck.Name = "IncludeEndAddressFilterCheck";
			this.IncludeEndAddressFilterCheck.Size = new System.Drawing.Size(124, 17);
			this.IncludeEndAddressFilterCheck.TabIndex = 3;
			this.IncludeEndAddressFilterCheck.Text = "Include End Address";
			this.IncludeEndAddressFilterCheck.UseVisualStyleBackColor = true;
			this.IncludeEndAddressFilterCheck.CheckedChanged += new System.EventHandler(this.RefreshEndFilter);
			this.IncludeEndAddressFilterCheck.TextChanged += new System.EventHandler(this.RefreshEndFilter);
			// 
			// EndAddressFilterCheck
			// 
			this.EndAddressFilterCheck.AutoSize = true;
			this.EndAddressFilterCheck.Location = new System.Drawing.Point(7, 54);
			this.EndAddressFilterCheck.Name = "EndAddressFilterCheck";
			this.EndAddressFilterCheck.Size = new System.Drawing.Size(86, 17);
			this.EndAddressFilterCheck.TabIndex = 2;
			this.EndAddressFilterCheck.Text = "End Address";
			this.EndAddressFilterCheck.UseVisualStyleBackColor = true;
			this.EndAddressFilterCheck.CheckedChanged += new System.EventHandler(this.EndAddressFilterCheck_CheckedChanged);
			// 
			// IncludeStartAddressFilterCheck
			// 
			this.IncludeStartAddressFilterCheck.AutoSize = true;
			this.IncludeStartAddressFilterCheck.Enabled = false;
			this.IncludeStartAddressFilterCheck.Location = new System.Drawing.Point(7, 37);
			this.IncludeStartAddressFilterCheck.Name = "IncludeStartAddressFilterCheck";
			this.IncludeStartAddressFilterCheck.Size = new System.Drawing.Size(124, 17);
			this.IncludeStartAddressFilterCheck.TabIndex = 1;
			this.IncludeStartAddressFilterCheck.Text = "Include StartAddress";
			this.IncludeStartAddressFilterCheck.UseVisualStyleBackColor = true;
			this.IncludeStartAddressFilterCheck.CheckedChanged += new System.EventHandler(this.RefreshStartFilter);
			this.IncludeStartAddressFilterCheck.TextChanged += new System.EventHandler(this.RefreshStartFilter);
			// 
			// StartAddressFilterCheck
			// 
			this.StartAddressFilterCheck.AutoSize = true;
			this.StartAddressFilterCheck.Location = new System.Drawing.Point(7, 20);
			this.StartAddressFilterCheck.Name = "StartAddressFilterCheck";
			this.StartAddressFilterCheck.Size = new System.Drawing.Size(86, 17);
			this.StartAddressFilterCheck.TabIndex = 0;
			this.StartAddressFilterCheck.Text = "Start Addess";
			this.StartAddressFilterCheck.UseVisualStyleBackColor = true;
			this.StartAddressFilterCheck.CheckedChanged += new System.EventHandler(this.StartAddressFilterCheck_CheckedChanged);
			// 
			// RamSearch
			// 
			this.AllowDrop = true;
			...
			this.ClientSize = new System.Drawing.Size(445, 587);
			this.Controls.Add(this.AddressRangeBox);
			...
			this.AddressRangeBox.ResumeLayout(false);
			this.AddressRangeBox.PerformLayout();
		...
		private System.Windows.Forms.GroupBox AddressRangeBox;
		private HexTextBox AddressEndFilterBox;
		private HexTextBox AddressStartFilterBox;
		private System.Windows.Forms.CheckBox IncludeEndAddressFilterCheck;
		private System.Windows.Forms.CheckBox EndAddressFilterCheck;
		private System.Windows.Forms.CheckBox IncludeStartAddressFilterCheck;
		private System.Windows.Forms.CheckBox StartAddressFilterCheck;
	}
}